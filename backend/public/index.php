...
/* ======== TEST ========= */
$router->get('/api/teacher/tests','TestController@teacherTest');
$router->post('/api/teacher/tests','TestController@store');
$router->delete('/api/teacher/tests/{id}', 'TestController@destroy');
$router->get('/api/teacher/tests/{id}', 'TestController@show');
$router->put('/api/teacher/tests/{id}', 'TestController@update');
$router->get('/api/teacher/tests/{id}/full', 'TestController@showFull');
// routes.php
$router->get('/api/teacher/exam-types', 'TestController@getExamTypes');
// Builder endpoints
$router->get('/api/teacher/tests/{id}/builder', 'TestController@getBuilder');
$router->put('/api/teacher/tests/{id}/builder', 'TestController@saveBuilder');
