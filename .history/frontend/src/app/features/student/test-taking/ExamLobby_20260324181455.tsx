...
export function ExamLobby() {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] bg-gradient-to-b from-[#EEF2FF] via-[#F8FAFC] to-[#E2E8F0] px-4 py-8 md:py-10">
      <div className="max-w-7xl mx-auto rounded-[28px] border-2 border-indigo-200 bg-white/95 p-6 md:p-10 shadow-[0_24px_80px_rgba(15,23,42,0.16)] ring-4 ring-indigo-100">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-7 mb-3">
          ...
          <section className="space-y-3">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
              <video ref={videoRef} autoPlay muted playsInline className="w-full h-40 object-cover rounded-lg bg-slate-200" />
              <button
