  ...
  // Teacher Routes với nested routing
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          title: "Course Managements - NamThuEdu",
        },
      },
      {
        ...
        component: () =>
          import("../views/Teacher/StudentManagements/HomePage.vue"),
        meta: {
          title: "Student Managements - NamThuEdu",
        },
      },
      {
        path: "studentmanagements/students",
        name: "TeacherStudentManagements",
        component: () =>
          import("../views/Teacher/StudentManagements/Students/index.vue"),
        meta: {
          title: "Student Managements - NamThuEdu",
        },
      },
      {
        ...
        name: "TeacherScoresManagements",
        component: () =>
          import("../views/Teacher/StudentManagements/Scores/index.vue"),
        meta: {
          title: "Student Managements - NamThuEdu",
        },
      },
      {
        path: "studentmanagements/check-in",
        name: "TeacherCheckInManagements",
        component: () => 
          import("../views/Teacher/StudentManagements/CheckIn/CheckIn.vue"),
        meta: {
          title: "Student Managements - Nam Thu Edu",
        }
      },
      {
        path: "classes",
        ...
        meta: {
          title: "Class Managements - NamThuEdu",
        },
      },
      {
        path: "tests",
        ...
        meta: {
          title: "Test Managements - NamThuEdu",
        },
      },
      {
        path: "blogs",
        name: "TeacherBlogs",
        component: () => import("../views/Teacher/BlogManagements/index.vue"),
        meta: {
          title: "Blog Managements - NamThuEdu"
        }
      },
      {
        path: "settings",
        name: "TeacherSettings",
        component: () => import("../views/Teacher/Settings/settings.vue"),
        meta: {
          title: "Settings - NameThuEdu"
        }
      }
    ],
  },
