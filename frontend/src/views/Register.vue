                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input 
                            ...
                            placeholder="Tạo mật khẩu mạnh nhé!"
                            required
                            :disabled="loading"
                        />
                        <button 
                    ...
                    <div class="password-strength">
                        <div class="strength-bars">
                            <div class="bar" :class="{ active: form.password.length > 0 }"></div>
                            <div class="bar" :class="{ active: form.password.length > 4 }"></div>
                            <div class="bar" :class="{ active: form.password.length > 7 }"></div>
                        </div>
                        <span class="strength-text">
                            {{ form.password.length === 0 ? '' : form.password.length < 5 ? 'Yếu' : form.password.length < 8 ? 'Trung bình' : 'Mạnh' }}
                        </span>
                    </div>
                </div>
...
const handleRegister = async () => {
    ...
    try {
        ...
        success.value = response.data.message || "Đăng ký thành công! 🎉";
...
.fun-fact {
    margin-top: 1.5rem;
    padding: 1rem;
    background: linear-gradient(135deg, #FFE66D20, #4ECDC420);
    border-radius: 16px;
