...
<template>
    <div v-if="isOpen" class="modal-overlay" @click.self="handleClose">
        <div class="modal-content">
            ...
            <!-- Content -->
            <div v-else-if="student" class="modal-body">
                <!-- Course Header Info -->
                <div class="course-header-info">
                    <div class="course-name-section">
                        <h2>{{ student.name }}</h2>
                    </div>
                    <span class="status-badge" :class="getStatusStudent(student.status)">
                        {{ student.status }}
                    </span>
                </div>
                ...
                <div class="info-grid">
                    ...
                    <div class="info-card">
                        ...
                        <div class="info-content">
                            <span class="info-label">Students Age</span>
            ...
            <!-- Footer Actions -->
            <div class="modal-footer" v-if="!loading && student">
...
const fetchStudentDetail = async () => {
    ...
    loading.value = true
    try {
        const res = await http.get(`/api/teacher/student/${props.studentId}`, {
            headers: {
...
const handleEdit = () => {
    ...
    emit('edit', student.value); // Gửi dữ liệu khóa học lên component cha
}

const handleDelete = async () => {
    const result = await Swal.fire({
        title: 'Are you sure?',
        text: `Student "${student.value.name}" will be permanently deleted!`,
        icon: 'warning',
    ...
    if (result.isConfirmed) {
        try {
            const res = await http.delete(`/api/teacher/student/${student.value.id}`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`
                }
            })
